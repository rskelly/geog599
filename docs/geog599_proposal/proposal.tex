...
\begin{figure} %[htbp] % htbp stand for "here", "top", "bottom", "page"
\includegraphics[width=1.0\linewidth]{tmp/splines_derivs_smooth_0.pdf} 
\includegraphics[width=1.0\linewidth]{tmp/splines_derivs_smooth_0_5.pdf} 
\includegraphics[width=1.0\linewidth]{tmp/splines_derivs_smooth_0_8.pdf} 
